...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { icon: UserSquare2, label: "Collectors", href: "/collectors" },
    { icon: ShieldAlert, label: "Committees", href: "/committees" },
    { icon: Ticket, label: "Tokens", href: "/tokens" },
    { icon: Wallet, label: "Loans", href: "/loans" },
    { icon: CreditCard, label: "Collections", href: "/collections" },
    { icon: Gift, label: "Lotteries", href: "/lotteries" },
